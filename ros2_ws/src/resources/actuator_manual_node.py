...
class ActuatorManualControlNode(Node):
    def __init__(self) -> None:
        super().__init__('actuator_manual_control')
        ...
        self.get_logger().info("Manual actuator control node started")
...
def main(args=None) -> None:
    ...
    node = ActuatorManualControlNode()
    node.print_help()
